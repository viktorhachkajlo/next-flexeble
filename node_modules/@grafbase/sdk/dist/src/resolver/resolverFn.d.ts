 ...
 *
 */
export type ResolverFn<Parent, Args, Return> = ((parent: Parent, args: Args, context: ResolverContext, info: ResolverInfo) => Return) | ((parent: Parent, args: Args, context: ResolverContext, pageInfo: ResolverInfo) => Promise<Return>);
//# sourceMappingURL=resolverFn.d.ts.map